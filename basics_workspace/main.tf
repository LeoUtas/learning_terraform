...
resource "aws_instance" "learning-aws-instance-dev" {
  ...
  tags = {
    Name        = "learning-aws-instance-dev"
    Team        = "HoangNgBots"
    Owner       = "HoangNg"
    Purpose     = "learning AWS and terraform"
    Environment = "learning"
...
# create an EC2 instance for production
resource "aws_instance" "learning-aws-instance-production" {
  ...
  tags = {
    Name        = "learning-aws-instance-production"
    Team        = "HoangNgBots"
    Owner       = "HoangNg"
    Purpose     = "learning AWS and terraform"
    Environment = "learning"
